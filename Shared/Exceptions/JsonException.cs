...
namespace Shared.Exceptions {
	...
	public class JTokenTypeException : JTokenException {
		...
		public JTokenTypeException(JToken actual, JTokenType expected, string message = null, Exception innerException = null) : base(actual, message, innerException) {
			Expected.Add(expected);
		}

		public JTokenTypeException(JToken actual, params JTokenType[] expected) : base(actual) {
